...
Each reource is a json file with a unique name, a unique path and a specific type. It is listed in a <a href="{{site.baseurl}}/resources/jsonindex">index</a> and contains all related information to describe part of the software system.
